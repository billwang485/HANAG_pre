...
__all__ = ['resnet18_deform_bottleneck']
...
class ResNet18_deform_bottleneck(nn.Module):
    def __init__(self, ResBlock, num_classes=10):
        super(ResNet18_deform_bottleneck, self).__init__()
        self.inchannel = 64
...
def resnet18_deform_bottleneck():
    return ResNet18_deform_bottleneck(ResBlock)